(function() {
  ...
  var queryInput, resultDiv, accessTokenInput, micBtn;
  ...
  function setAccessToken() {
    ...
    streamClient.onResults  = showStreamClientResponse;
  ...
  function showStreamClientResponse(response) {
      var value = response.result.resolvedQuery;
